...
3.  Determine chromosomal sex check\

4.  Check for duplicates and cryptic relatedness\

5.  Individual quality filtering\

6.  Genotype quality control for autosomes\

5: GENERATE PLINK FILES STEP 6: RELATIONSHIP INFERENCE AND MENDEL ERRORS STEP 7: STRINGENT MISSINGNESS QC STEP 8: GENERAL REPORT OF POST QC STATISTICS STEP 9: PRINCIPAL COMPONENT ANALYSIS TO DETECT BATCH EFFECTS
